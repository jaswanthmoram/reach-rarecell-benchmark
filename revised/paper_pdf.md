...
![Figure 0. Phase 11 summary heatmap: mean AP by method and dataset.](images/Fig0_Phase11_Summary_Heatmap.png)
...
![Figure 9. Track design overview including the new Track F (intra-lineage).](images/Fig9_Track_Design.png)

![Figure 8. REACH pipeline overview with the real CNV inference arm.](images/Fig8_REACH_Pipeline_Overview.png)
...
![Figure 10. Method QC audit: failure modes and degenerate output rates.](images/Fig10_Method_QC_Audit.png)
...
![Figure 1. Primary leaderboard (Track A): median average precision per method.](images/Fig1_Leaderboard.png)
...
![Figure 2. Sensitivity and robustness analysis (Track E label-noise).](images/Fig2_Sensitivity_Robustness.png)

![Figure 3. Critical difference diagram for method ranking.](images/Fig3_Critical_Difference.png)

![Figure 4. Average precision stratified by rare-cell prevalence.](images/Fig4_AP_Prevalence.png)

![Figure 5. Track C null-control calibration: per-method false-positive rate.](images/Fig5_TrackC_Null_Calibration.png)

![Figure 6. Runtime scalability Pareto: runtime vs dataset size.](images/Fig6_Runtime_Scalability_Pareto.png)

![Figure 7. Rank bootstrap forest: rank stability across datasets.](images/Fig7_Rank_Bootstrap_Forest.png)

![Figure 11. Track F (intra-lineage) vs Track A (inter-lineage) median AP per method. hvg_logreg ceiling collapses from 1.000 to 0.001; scMalignantFinder inverts (0.235 to 1.000).](images/Fig11_Track_F_vs_Track_A.png)
