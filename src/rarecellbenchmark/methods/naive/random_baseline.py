"""
src/rarecellbenchmark/methods/naive/random_baseline.py
REACH - Naive Baseline: Random Scorer

Assigns a random score drawn from U[0,1] to each cell.
Expected AP ≈ prevalence (chance level).
Serves as the absolute floor for all methods.
"""
...
class RandomBaselineWrapper(BaseMethodWrapper):
    method_id = "random_baseline"
    category = "naive"
    supports_gpu = False
